...
<footer>
                ...
                <div class="w3ls-post-grids">
                    <div class="w3ls-post-grid">
                        <div class="w3ls-post-img">
                            <a href="#"><img src="{{ asset('public/frontend/images/p1.jpg')}}" alt="" /></a>
                        </div>
                    ...
                    <div class="w3ls-post-grid">
                        <div class="w3ls-post-img">
                            <a href="#"><img src="{{ asset('public/frontend/images/p2.jpg')}}" alt="" /></a>
                        </div>
                        <div class="w3ls-post-info">
                            <h6><a href="#" data-toggle="modal" data-target="#myModal">Donec vel sapien in erat</a></h6>
                            <p>June 17,2017</p>
                    ...
                    <div class="w3ls-post-grid">
                        <div class="w3ls-post-img">
                            <a href="#"><img src="{{ asset('public/frontend/images/p3.jpg')}}" alt="" /></a>
                        </div>
                        <div class="w3ls-post-info">
                            <h6><a href="#" data-toggle="modal" data-target="#myModal">Donec vel sapien in erat</a></h6>
                            <p>June 26,2017</p>
    ...
    <div class="copyright">
        <div class="container">
            <p>© {{ date('Y') }} Transporters. All rights reserved | Design by <a href="http://www.movoeasy.com">MovoEasy</a></p>
        </div>
    </div>
</footer>
<!-- //footer -->
